...
#include "CommonBinkMediaPlayer.generated.h"
...
class COMMONBINKMEDIAPLAYER_API UCommonBinkMediaPlayer final : public UWidget
{
	GENERATED_BODY()

public:
	UCommonBinkMediaPlayer(const FObjectInitializer& ObjectInitializer);
