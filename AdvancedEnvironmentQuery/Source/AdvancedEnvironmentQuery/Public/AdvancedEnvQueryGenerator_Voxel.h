...
#include "AdvancedEnvQueryGenerator_Voxel.generated.h"

/**
 * 복셀 생성기
 */
UCLASS(meta = (DisplayName = "Points: Voxel"))
class ADVANCEDENVIRONMENTQUERY_API UAdvancedEnvQueryGenerator_Voxel final : public UEnvQueryGenerator
{
	GENERATED_BODY()

public:
	UAdvancedEnvQueryGenerator_Voxel(const FObjectInitializer& ObjectInitializer);
