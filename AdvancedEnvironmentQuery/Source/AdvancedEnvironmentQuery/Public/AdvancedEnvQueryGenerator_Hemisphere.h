...
#include "AdvancedEnvQueryGenerator_Hemisphere.generated.h"

/**
 * 반구 생성기
 */
UCLASS(meta = (DisplayName = "Points: Hemisphere"))
class ADVANCEDENVIRONMENTQUERY_API UAdvancedEnvQueryGenerator_Hemisphere final : public UEnvQueryGenerator
{
	GENERATED_BODY()

public:
	UAdvancedEnvQueryGenerator_Hemisphere(const FObjectInitializer& ObjectInitializer);
