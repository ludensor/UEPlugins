...
#include "AdvancedEnvQueryGenerator_Voxel.h"
...
UAdvancedEnvQueryGenerator_Voxel::UAdvancedEnvQueryGenerator_Voxel(const FObjectInitializer& ObjectInitializer)
...
void UAdvancedEnvQueryGenerator_Voxel::GenerateItems(FEnvQueryInstance& QueryInstance) const
{
...
void UAdvancedEnvQueryGenerator_Voxel::StoreNavPoints(const TArray<FNavLocation>& Points, FEnvQueryInstance& QueryInstance) const
{
...
FText UAdvancedEnvQueryGenerator_Voxel::GetDescriptionTitle() const
{
...
FText UAdvancedEnvQueryGenerator_Voxel::GetDescriptionDetails() const
{
...
#if WITH_EDITOR
void UAdvancedEnvQueryGenerator_Voxel::PostEditChangeProperty(FPropertyChangedEvent& PropertyChangedEvent)
{
	if (PropertyChangedEvent.Property)
	{
		const FName PropName = PropertyChangedEvent.MemberProperty->GetFName();
		if (PropName == GET_MEMBER_NAME_CHECKED(UAdvancedEnvQueryGenerator_Voxel, GridSize))
		{
		...
		else if (PropName == GET_MEMBER_NAME_CHECKED(UAdvancedEnvQueryGenerator_Voxel, HorizontalSpaceBetween))
		{
		...
		else if (PropName == GET_MEMBER_NAME_CHECKED(UAdvancedEnvQueryGenerator_Voxel, VerticalSpaceBetween))
		{
